// Для зберігання даних про планшетні сканери описаstruct scan_info {
...
// Написати функцію, яка динамічно вид//іляє пам'ять під масив структур (не
...
//2
// Написати функцію, яка отримує дані про сканер з описаного вище
// бінарного файлу в структуру типу scanjnfo. Обов'язковий параметр - номер
// необхідного запису. Функція повинна повертати нульове значення, якщо
// читання пройшло успішно, і -1 в іншому випадку.
...
struct scan_info {
	...
	double y_size; // вертикальний розмір області int optr; // оптична роздільна здатність
	int grey; // число градацій сірого
};
